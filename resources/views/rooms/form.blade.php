<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">Habitacion</label>
    <div class="col-md-9">
        <input type="text" name="name" id="name"  required class="form-control" placeholder="Nombre de habitacion">  
    </div>
</div>
<div class="form-group row">
    <label class="col-md-3 form-control-label" for="text-input">Precio</label>
    <div class="col-md-9">
        <input type="number" name="price" id="price"  required class="form-control" placeholder="Precio">  
    </div>
</div>
<div class="form-group row">
